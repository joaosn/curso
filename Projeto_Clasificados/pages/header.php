    	...
    	<div class="container-fluid">
    		...
    		<ul class="nav navbar-bar navbar-right ">
                 ...
                 <?php require 'classes/usuarios.class.php';
                      ?>                     
                     <li class="lok1" style="color:#c6eebd; ">Bem vindo <?=Usuarios::User(utf8_encode(($_SESSION['clogin'])));?>
                         
                     </li>
                     <li class="lok"><a href="meus-anucios.php">Meus <?php echo utf8_encode('anúcios') ?></a></li>   
