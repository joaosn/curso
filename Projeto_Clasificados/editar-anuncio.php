...
$info = $a->getAnuncio($_GET['id']);
  ...
  ?>
   <script type="text/javascript">window.location.href="meus-anucios.php";</script>
  <?php
  exit;
}
?>
         ...
         <div class="card" style="width:auto;"> 
           <div class="card-body">
              <?php foreach ($info['fotos'] as $foto): ?>
                <div class="foto_item">
                  <img src="assetes/img/anuncios/<?php echo $foto['url']; ?>" border="0" class="img-thumbnail"><br>
                   <a href="excluir-foto.php?id=<?php echo $foto['id']; ?>" class="btn btn-danger btn-sm">excluir</a>
                </div>
