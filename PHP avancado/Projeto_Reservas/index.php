...
<h1>Reservas</h1>
<br>
<a href="reservar.php">add reservas</a>
<br>
<br>
...
//echo "primero dia: ".$dia1."<br>";
//echo "total de dias: ".$dias."<br>";
//echo "linhas do mes: ".$linhas."<br>";
//echo "data inicio: ".$data_inicio."<br>";
//echo "ultimo dia: ".$data_fim."<br>";
...
$data2 = date('d/m/Y',strtotime($item['data_fim']));
	    echo $item['pessoa'].' reservou o carro '.$item['id_carro'].' entre '.$data1.' ao dia '.$data2.'<br><br>';
}*/
?>
<hr>
